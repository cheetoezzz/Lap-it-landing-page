    ...
    <div className='flex flex-col'>
      ...
      <div className='flex flex-row'>
        <section className='w-1/2'>
          <h1 className='text-slate-600 text-base mt-28 ml-40'>Lorem ipsum dolor sit amet consectetur. Lacinia risus <strong> quam 
        ...
        <div className='mt-7'>
          ...
          <section className='w-1/2'>
            <div className="flex justify-end items-end mr-64 mt-20">
              <Image src="/Asset.png" alt="Image Description" width={400} height={300} />
            </div>
          </section>
      </div>
    </div>
