  ...
  return (
    <div className="relative flex justify-center items-center">
      <div className=" mx-[4px] sm:mx-[10px] md:mx-[15px] xl:mx-[15px] w-[100px] h-[100px] sm:w-[170px] sm:h-[170px] md:w-[250px] md:h-[250px] xl:w-[350px] xl:h-[350px] xl:mt-7 border border-blue-500 hover:bg-blue-500 hover:text-white duration-1000 rounded-lg">
        <div className="mx-2 mt-3 w-5 h-5 sm:mx-3 sm:mt-4 sm:w-8 sm:h-8 md:mx-4 md:mt-5 md:w-12 md:h-12 xl:mx-6 xl:mt-7 xl:w-20 xl:h-20 bg-white rounded-full ">
          <img src={iconSrc} alt={title} className="w-[15px] h-[15px] translate-y-[2px] sm:w-[25px] sm:h-[25px] md:w-[35px] md:h-[45px] xl:w-[55px] xl:h-[55px] xl:translate-y-3 mx-auto " />
        </div>
