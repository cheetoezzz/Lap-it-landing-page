        ...
        <div className="w-screen h-[80vh] relative">
          ...
          <div className="mt-14">
            <div className="flex flex-row items-center justify-center ">
              <div className="bg-blue-50 border p-[32px] mx-10">
                <div className=" w-[612px] h-[300px]">
                  <h1 className="text-blue-500 font-extrabold text-[36px]">
                    OUR MISSION
                  </h1>

                  <h1 className="text-gray-500 font-extralight text-[16px] mt-5">
