...
const Card: React.FC<CardProps> = ({ description, title, iconSrc }) => {
  return (
    <div className="w-[350px] h-96 border bg-white border-blue-500 rounded-md shadow-xl flex flex-col justify-center hover:scale-110 duration-700 transition-all">
