const Hero = () => {
  return (
    <div className="">
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 xl:flex-row bg-cover bg-center' style={{backgroundImage: "url('/tao1.png')", height: "400px"}}>
        <div>
            <div className="ml-12">
                <h1 className="text-4xl font-bold text-white">Empower your Experience width
                    <br />
                ...
                <div className="flex flex-col items-center mt-14">
                    <div className="bg-blue-600 w-3/6 h-40 rounded-sm flex items-center justify-between">
                        <div className="text-white text-lg font-semibold ml-9 mb-6">
                            ...
                            <br />
                            <a className="underline" href="">Go to Pricing</a>
                        </div>
