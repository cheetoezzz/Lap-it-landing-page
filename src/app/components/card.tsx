...
const Card = ({ description, title, iconSrc }: CardProps) => {
  return (
    <div className="">
      <div className="w-72 h-72 border bg-white border-blue-500 rounded-md ml-9 shadow-xl flex flex-col justify-center hover:scale-110 duration-700 transition-all">
